...
@app.post("/quizzes", response_model=schemas.QuizEditorOut, status_code=status.HTTP_201_CREATED)
...
@app.get("/quizzes", response_model=list[schemas.QuizSummaryOut])
...
@app.get("/quizzes/{quiz_id}", response_model=schemas.QuizDetailOut)
...
@app.get("/quizzes/{quiz_id}/edit-data", response_model=schemas.QuizEditorOut)
...
@app.put("/quizzes/{quiz_id}", response_model=schemas.QuizEditorOut)
...
@app.post("/quizzes/{quiz_id}/start", response_model=schemas.QuizAttemptSessionOut)
...
@app.get("/quiz-attempts/{attempt_id}", response_model=schemas.QuizAttemptSessionOut)
...
@app.put("/quiz-attempts/{attempt_id}/answers/{question_id}", response_model=schemas.QuizAttemptSessionOut)
...
@app.post("/quiz-attempts/{attempt_id}/complete", response_model=schemas.QuizResultOut)
...
@app.get("/quiz-attempts/{attempt_id}/results", response_model=schemas.QuizResultOut)
